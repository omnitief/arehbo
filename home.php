...
$page_title    = $posts_page_id ? get_the_title($posts_page_id) : __('Blogs', 'arehbo-theme');
$page_desc     = $posts_page_id ? get_the_excerpt($posts_page_id) : '';
    ...
    <div class="archive-hero bg-light">
        <div class="archive-hero__inner container">
            ...
            <nav class="archive-breadcrumbs" aria-label="Breadcrumb">
                ...
                <span class="archive-breadcrumbs__current" aria-current="page"><?= esc_html($page_title); ?></span>
            </nav>

            <hr class="archive-hero__divider">

            <h1 class="archive-hero__title"><?= esc_html($page_title); ?></h1>

            <?php if ($page_desc) : ?>
                <p class="archive-hero__desc"><?= esc_html($page_desc); ?></p>
            <?php endif; ?>
